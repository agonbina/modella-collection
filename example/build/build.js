...
require.register("forbeslindesay~is-browser@2.0.0", function (exports, module) {
module.exports = true;
});

require.register("modella~modella@0.2.8", function (exports, module) {
/**
 * Module dependencies
 */

var modella = module.exports = require("modella~modella@0.2.8/lib/model.js");

modella.utils = {};
modella.utils.clone = require("modella~modella@0.2.8/lib/utils/clone.js");
modella.utils.type = require("modella~modella@0.2.8/lib/utils/type.js");

});

require.register("modella~modella@0.2.8/lib/model.js", function (exports, module) {
/**
 * Module dependendencies
 */

var proto = require("modella~modella@0.2.8/lib/proto.js");
var statics = require("modella~modella@0.2.8/lib/static.js");
var clone = require("modella~modella@0.2.8/lib/utils/clone.js");
...
require.register("modella~modella@0.2.8/lib/proto.js", function (exports, module) {
...
require.register("modella~modella@0.2.8/lib/static.js", function (exports, module) {
...
var clone = require("modella~modella@0.2.8/lib/utils/clone.js"),
    type = require("modella~modella@0.2.8/lib/utils/type.js"),
    isBrowser = require("forbeslindesay~is-browser@2.0.0"),
    noop = function(){};
...
require.register("modella~modella@0.2.8/lib/utils/clone.js", function (exports, module) {
/**
...
var type = require("modella~modella@0.2.8/lib/utils/type.js");
...
require.register("modella~modella@0.2.8/lib/utils/type.js", function (exports, module) {
/**
...
require.register("agonbina~modella-collection@master", function (exports, module) {

module.exports = require("agonbina~modella-collection@master/lib/collection-plugin.js");
});

require.register("agonbina~modella-collection@master/lib/collection.js", function (exports, module) {
...
require.register("agonbina~modella-collection@master/lib/collection-plugin.js", function (exports, module) {

/**
 * Module dependencies
 */

var Collection = require("agonbina~modella-collection@master/lib/collection.js");
...
var modella = require("modella~modella@0.2.8");
var collection = require("agonbina~modella-collection@master");
